    ...
    <nav class="glass" style="position:fixed;top:0;left:0;right:0;z-index:var(--z-sticky);padding:var(--space-4) 0;">
        <div class="container flex justify-between items-center">
            ...
            <ul class="flex gap-6" style="list-style:none;margin:0;padding:0;">
                ...
                <li><a href="/user/login.php" class="btn btn-sm btn-primary">Kirish</a></li>
            </ul>
        </div>
    </nav>
        ...
        <div class="container">
            ...
            <div class="grid grid-cols-1" style="gap:var(--space-6);">
                ...
                <div class="card glass-card scroll-animate">
                    ...
                    <a href="/blog/view.php?id=<?php echo $post['id']; ?>" class="btn btn-sm btn-outline">Davomi</a>
                </div>
                <?php endforeach; ?><?php endif; ?>
            </div>
        </div>
    ...
    <section id="contact" class="section" style="background:var(--bg-secondary);">
        <div class="container">
            <div style="max-width:600px;margin:0 auto;">
                ...
                <form class="card glass-card scroll-animate" data-ajax action="/api/submit-application.php" method="POST">
    ...
    <footer class="glass" style="padding:var(--space-12) 0;border-top:1px solid var(--border-color);">
        <div class="container">
            <div class="grid grid-cols-1" style="gap:var(--space-8);">
                ...
                <div><h4 style="margin-bottom:var(--space-4);">Hujjatlar</h4><ul style="list-style:none;padding:0;"><li style="margin-bottom:var(--space-2);"><a href="/privacy.php">Maxfiylik siyosati</a></li><li style="margin-bottom:var(--space-2);"><a href="/terms.php">Foydalanish shartlari</a></li></ul></div>
            </div>
